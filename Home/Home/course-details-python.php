...
<head>
    ...
    <link rel="stylesheet" href="css/course-details-python.css">
...
<body>
    ...
    <section class="another">
        <div class="another-one">
            <h2><span class="section-heading">Mastering PYTHON From Zero To<br>Hero</span></h2>
        </div>

        <div class="another-two">
            <a href="#" class="home-link">Home</a> <h4>/  Mastering PYTHON from zero to hero</h4>
        </div>
    </section>
    ...
    <script src="js/course-details-python.js"></script>
</body>
</html>
