...
<body>
    ...
    <section class="another">
        <div class="another-one">
            <h2><span class="section-heading">Frequently Asked questions</span></h2>
        </div>
    ...
    <!-- body end -->
        ...
        <section class="content">
            ...
            <h1>Are the courses self-paced?</h1>
            ...
            <h1>Do you offer certificates upon course completion?</h1>
            ...
            <h1>Can I access the courses on mobile devices?</h1>
