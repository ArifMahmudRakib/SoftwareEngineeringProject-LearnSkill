...
if(isset($_POST['order_btn'])){
   ...
   $detail_query = mysqli_query($conn, "INSERT INTO `order`(name, number, email, method, flat, street, city, pin_code, total_products, total_price) VALUES('$name','$number','$email','$method','$flat','$street','$city','$pin_code','$total_product','$price_total')") or die('query failed');
   ...
   if($cart_query && $detail_query){
      ...
      <div class='message-container'>
         ...
         <div class='customer-details'>
            ...
            <a href='products.php' class='btn'>continue Checking the course</a>
         </div>
      </div>
      ";
   }
...
<section class="checkout-form">
   ...
   <div class="display-order">
      ...
      <?php
         ...
         echo "<div class='display-order'><span>your Course is empty!</span></div>";
      }
      ?>
