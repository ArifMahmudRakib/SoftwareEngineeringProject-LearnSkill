...
<html lang="en">
  <head>
    ...
    <link rel="stylesheet" href="css/course-details-java.css" />
    <link
      rel="stylesheet"
  ...
  <body>
    ...
    <section class="another">
      <div class="another-one">
        <h2>
          <span class="section-heading"
            >Mastering JAVA From Zero To<br />Hero</span
          >
        </h2>
      </div>
      ...
      <div class="another-two">
        ...
        <h4>/ Mastering JAVA from zero to hero</h4>
      </div>
    </section>
    ...
    <div class="course-container">
      ...
      <div class="main-content">
        ...
        <button class="enroll-button" onclick="showSuccessMessage()">
          Enroll Course
        </button>
    ...
    <script src="js/course-details-java.js"></script>
  </body>
</html>
