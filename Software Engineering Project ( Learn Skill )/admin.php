...
if(isset($_POST['add_product'])){
   ...
   if($insert_query){
      ...
      $message[] = 'Course add succesfully';
   }else{
...
<form action="" method="post" class="add-product-form" enctype="multipart/form-data">
   ...
   <input type="number" name="p_price" min="0" placeholder="enter the Course price" class="box" required>
   <input type="file" name="p_image" accept="image/png, image/jpg, image/jpeg" class="box" required>
   <input type="text" name="p_description" placeholder="enter the Course description" class="box" required>
   ...
   <table>
      ...
      <tbody>
         ...
         <?php
               ...
               echo "<div class='empty'>no Course added</div>";
            };
         ?>
      </tbody>
   </table>
