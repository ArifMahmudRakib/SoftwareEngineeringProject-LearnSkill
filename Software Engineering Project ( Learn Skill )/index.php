...
?>
    ...
    <div class="header">
      ...
      <div class="content">
      <form action="index1.php" role="search" method="GET">
          <input type="text" name="key" placeholder="&#x270e; Enter Keyword" />
          <button name="search" type="submit">Find Course</button>
        </form>
    ...
    <section class="main-section">
      ...
      <div class="content-div">
        ...
        <a href="course-page.php" class="courses-button">Our Courses</a>
          ...
          <div class="row">
            ...
            <div class="col" id="Explore">
              ...
              <div class="links">
                ...
                <a href="OurServices A.php">Our Services</a>
                <a href="FAQA.php">FAQ</a>
