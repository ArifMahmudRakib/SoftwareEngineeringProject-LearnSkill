...
<html lang="en">
  ...
  <body>
    <header class="Header">
      <nav id="main-nav">
        <h2>
          <a href="demo3.html"><span>Learn</span> Skill</a>
        </h2>
        <div class="nav-link">
          <ul>
            ...
            <li>
              <a href="useProfile.php?id=<?php echo $_SESSION['id'] ?>"
    ...
    <main>
      <div class="services-container">
        <div class="service">
          ...
          <p>
            Explore a wide range of online courses taught by industry experts.
          </p>
        </div>
        <div class="service">
          ...
          <p>
            Get personalized tutoring from qualified instructors in various
            subjects.
          </p>
        </div>
        <div class="service">
          ...
          <p>
            Access a vast library of study materials, notes, and practice
            exercises.
          </p>
        </div>
        <!-- Add more services -->
        ...
        <div class="service">
          ...
          <p>
            Participate in various extracurricular activities to enhance your
            skills.
          </p>
        </div>
      </div>
